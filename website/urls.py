...
urlpatterns = [
    ...
    path('accounts/signup/student/', AudienceSignUpView.as_view(), name='audience_signup'),
    path('accounts/signup/teacher/', StaffSignUpView.as_view(), name='staff_signup'),
    ...
    url(r'^postbyuser/$',postbyuser,name='postbyuser'),
